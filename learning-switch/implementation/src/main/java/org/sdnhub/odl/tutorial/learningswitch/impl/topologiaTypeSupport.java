...
public class topologiaTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "topologia";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final topologiaTypeSupport _singleton
    = new topologiaTypeSupport();
    ...
    */
    public static topologiaTypeSupport get_instance() {
        return _singleton;
    }

    public static topologiaTypeSupport getInstance() {
        return get_instance();
    }
    ...
    * <code>this</code> is not a <code>topologia</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        topologia typedDst = (topologia) destination;
        topologia typedSrc = (topologia) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE))+1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE))+1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE))+1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE))+1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE))+1);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        topologia typedSrc = (topologia) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.Identificador );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.NodeId );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.TerminationPointId );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.LinkId );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.SourceNode );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.SourceNodeTp );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.DestinationNode );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.DestinationNodeTp );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.Identificador,(org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.NodeId,(org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.TerminationPointId,(org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.LinkId,(org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.SourceNode,(org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.SourceNodeTp,(org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.DestinationNode,(org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.DestinationNodeTp,(org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            topologia typedDst = (topologia) dst;
            typedDst.clear();      
            try{
                typedDst.Identificador = src.readString((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));
                typedDst.NodeId = src.readString((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));
                typedDst.TerminationPointId = src.readString((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));
                typedDst.LinkId = src.readString((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));
                typedDst.SourceNode = src.readString((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));
                typedDst.SourceNodeTp = src.readString((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));
                typedDst.DestinationNode = src.readString((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));
                typedDst.DestinationNodeTp = src.readString((org.sdnhub.odl.tutorial.learningswitch.impl.MAX_SIZE.VALUE));
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            topologia typedDst = (topologia) sample;
    ...
    int mask) {
        return new topologiaDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new topologiaDataReader(native_reader, listener, mask, this);   
    ...
    protected topologiaTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, null ,topologia.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected topologiaTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, null ,topologia.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
