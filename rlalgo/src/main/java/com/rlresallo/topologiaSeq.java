...
/**
* A sequence of topologia instances.
*/
public final class topologiaSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public topologiaSeq() {
        super(topologia.class);
    }

    public topologiaSeq (int initialMaximum) {
        super(topologia.class, initialMaximum);
    }

    public topologiaSeq (Collection elements) {
        super(topologia.class, elements);
    }
