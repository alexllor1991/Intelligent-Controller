...
public class topologiaTypeSupport extends TypeSupportImpl {
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((com.rlresallo.MAX_SIZE.VALUE))+1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((com.rlresallo.MAX_SIZE.VALUE))+1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((com.rlresallo.MAX_SIZE.VALUE))+1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((com.rlresallo.MAX_SIZE.VALUE))+1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((com.rlresallo.MAX_SIZE.VALUE))+1);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.Identificador,(com.rlresallo.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.NodeId,(com.rlresallo.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.TerminationPointId,(com.rlresallo.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.LinkId,(com.rlresallo.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.SourceNode,(com.rlresallo.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.SourceNodeTp,(com.rlresallo.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.DestinationNode,(com.rlresallo.MAX_SIZE.VALUE));

            dst.writeString(typedSrc.DestinationNodeTp,(com.rlresallo.MAX_SIZE.VALUE));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            try{
                typedDst.Identificador = src.readString((com.rlresallo.MAX_SIZE.VALUE));
                typedDst.NodeId = src.readString((com.rlresallo.MAX_SIZE.VALUE));
                typedDst.TerminationPointId = src.readString((com.rlresallo.MAX_SIZE.VALUE));
                typedDst.LinkId = src.readString((com.rlresallo.MAX_SIZE.VALUE));
                typedDst.SourceNode = src.readString((com.rlresallo.MAX_SIZE.VALUE));
                typedDst.SourceNodeTp = src.readString((com.rlresallo.MAX_SIZE.VALUE));
                typedDst.DestinationNode = src.readString((com.rlresallo.MAX_SIZE.VALUE));
                typedDst.DestinationNodeTp = src.readString((com.rlresallo.MAX_SIZE.VALUE));
